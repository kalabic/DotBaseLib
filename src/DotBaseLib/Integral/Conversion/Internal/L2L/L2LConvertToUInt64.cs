...
internal static unsafe class L2LConvertToUInt64
{
    internal static void AddToTable(IConversionDelegateTable table)
    {
        table.SetCustomFunc(L2L_UInt8_To_UInt64, ByteOrder.LittleEndian, IntegralType.UInt8, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_Int8_To_UInt64, ByteOrder.LittleEndian, IntegralType.Int8, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_UInt16_To_UInt64, ByteOrder.LittleEndian, IntegralType.UInt16, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_Int16_To_UInt64, ByteOrder.LittleEndian, IntegralType.Int16, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_UInt32_To_UInt64, ByteOrder.LittleEndian, IntegralType.UInt32, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_Int32_To_UInt64, ByteOrder.LittleEndian, IntegralType.Int32, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_UInt64_To_UInt64, ByteOrder.LittleEndian, IntegralType.UInt64, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_Int64_To_UInt64, ByteOrder.LittleEndian, IntegralType.Int64, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_Float_To_UInt64, ByteOrder.LittleEndian, IntegralType.Float, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetCustomFunc(L2L_Double_To_UInt64, ByteOrder.LittleEndian, IntegralType.Double, ByteOrder.LittleEndian, IntegralType.UInt64);

        table.SetDefaultFunc(L2L_UInt8_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.UInt8, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_Int8_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.Int8, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_UInt16_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.UInt16, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_Int16_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.Int16, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_UInt32_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.UInt32, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_Int32_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.Int32, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_UInt64_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.UInt64, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_Int64_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.Int64, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_Float_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.Float, ByteOrder.LittleEndian, IntegralType.UInt64);
        table.SetDefaultFunc(L2L_Double_To_UInt64_Default, ByteOrder.LittleEndian, IntegralType.Double, ByteOrder.LittleEndian, IntegralType.UInt64);
    }

    public static long L2L_UInt8_To_UInt64(
    ...
    public static long L2L_UInt8_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int8_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int8_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_UInt16_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_UInt16_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int16_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int16_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_UInt32_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_UInt32_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int32_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int32_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_UInt64_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_UInt64_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int64_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Int64_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Float_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Float_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Double_To_UInt64(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
    ...
    public static long L2L_Double_To_UInt64_Default(
        in IntegralSpan input,
        in IntegralSpan output,
        long valuesCount,
        NumericConverters context)
