...
internal static unsafe class B2BConvertToUInt32
{
    ...
    {
        table.SetCustomFunc(B2B_UInt8_To_UInt32, ByteOrder.BigEndian, IntegralType.UInt8, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_Int8_To_UInt32, ByteOrder.BigEndian, IntegralType.Int8, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_UInt16_To_UInt32, ByteOrder.BigEndian, IntegralType.UInt16, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_Int16_To_UInt32, ByteOrder.BigEndian, IntegralType.Int16, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_UInt32_To_UInt32, ByteOrder.BigEndian, IntegralType.UInt32, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_Int32_To_UInt32, ByteOrder.BigEndian, IntegralType.Int32, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_UInt64_To_UInt32, ByteOrder.BigEndian, IntegralType.UInt64, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_Int64_To_UInt32, ByteOrder.BigEndian, IntegralType.Int64, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_Float_To_UInt32, ByteOrder.BigEndian, IntegralType.Float, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetCustomFunc(B2B_Double_To_UInt32, ByteOrder.BigEndian, IntegralType.Double, ByteOrder.BigEndian, IntegralType.UInt32);

        table.SetDefaultFunc(B2B_UInt8_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.UInt8, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_Int8_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.Int8, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_UInt16_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.UInt16, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_Int16_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.Int16, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_UInt32_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.UInt32, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_Int32_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.Int32, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_UInt64_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.UInt64, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_Int64_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.Int64, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_Float_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.Float, ByteOrder.BigEndian, IntegralType.UInt32);
        table.SetDefaultFunc(B2B_Double_To_UInt32_Default, ByteOrder.BigEndian, IntegralType.Double, ByteOrder.BigEndian, IntegralType.UInt32);
    }
