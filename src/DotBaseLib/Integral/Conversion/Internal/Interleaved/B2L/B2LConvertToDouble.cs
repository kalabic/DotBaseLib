...
internal static unsafe class B2LConvertToDouble
{
        ...
        in IntegralFormat input)
    {
        ...
        {
            IntegralType.UInt8 => new(B2L_UInt8_To_Double, B2L_UInt8_To_Double_Default),
            IntegralType.Int8 => new(B2L_Int8_To_Double, B2L_Int8_To_Double_Default),
            IntegralType.UInt16 => new(B2L_UInt16_To_Double, B2L_UInt16_To_Double_Default),
            IntegralType.Int16 => new(B2L_Int16_To_Double, B2L_Int16_To_Double_Default),
            IntegralType.UInt32 => new(B2L_UInt32_To_Double, B2L_UInt32_To_Double_Default),
            IntegralType.Int32 => new(B2L_Int32_To_Double, B2L_Int32_To_Double_Default),
            IntegralType.UInt64 => new(B2L_UInt64_To_Double, B2L_UInt64_To_Double_Default),
            IntegralType.Int64 => new(B2L_Int64_To_Double, B2L_Int64_To_Double_Default),
            IntegralType.Float => new(B2L_Float_To_Double, B2L_Float_To_Double_Default),
            IntegralType.Double => new(B2L_Double_To_Double, B2L_Double_To_Double_Default),
