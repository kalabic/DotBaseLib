...
internal static unsafe class B2BConvertToDouble
{
        ...
        in IntegralFormat input)
    {
        ...
        {
            IntegralType.UInt8 => new(B2B_UInt8_To_Double, B2B_UInt8_To_Double_Default),
            IntegralType.Int8 => new(B2B_Int8_To_Double, B2B_Int8_To_Double_Default),
            IntegralType.UInt16 => new(B2B_UInt16_To_Double, B2B_UInt16_To_Double_Default),
            IntegralType.Int16 => new(B2B_Int16_To_Double, B2B_Int16_To_Double_Default),
            IntegralType.UInt32 => new(B2B_UInt32_To_Double, B2B_UInt32_To_Double_Default),
            IntegralType.Int32 => new(B2B_Int32_To_Double, B2B_Int32_To_Double_Default),
            IntegralType.UInt64 => new(B2B_UInt64_To_Double, B2B_UInt64_To_Double_Default),
            IntegralType.Int64 => new(B2B_Int64_To_Double, B2B_Int64_To_Double_Default),
            IntegralType.Float => new(B2B_Float_To_Double, B2B_Float_To_Double_Default),
            IntegralType.Double => new(B2B_Double_To_Double, B2B_Double_To_Double_Default),
