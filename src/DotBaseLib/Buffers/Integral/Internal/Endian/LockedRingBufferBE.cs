...
internal sealed class LockedRingBufferBE 
    : LockedRingBuffer
{
    ...
    public override int ReadChecked(in IntegralSpan destination)
    {
        lock (_lock)
        {
            return IntegralRingOperationsBE.ReadChecked(ref _storage, destination);
        }
    }
    ...
    public override int WriteChecked(in IntegralSpan source)
    {
        lock (_lock)
        {
            return IntegralRingOperationsBE.WriteChecked(ref _storage, source);
        }
    }
